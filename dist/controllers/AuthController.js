...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.authenticate = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, login, password, user, isPasswordValid, token, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        token = jsonwebtoken_1.default.sign({ id: user.id }, 'secretpassword', {
                            expiresIn: '1h', // Define a validade do token (opcional)
                        });
                        return [2 /*return*/, res.json({ token: token })];
                    case 4:
                        error_1 = _b.sent();
                        return [2 /*return*/, res.status(500).json({ error: 'Erro ao autenticar usuário' })];
